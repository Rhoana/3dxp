...
4) sbatch --export=WORKING_DIR=$WORKING_DIR,RAW_RATIO=$RAW_RATIO,IDS_RATIO=$IDS_RATIO,VOXEL_RATIO=$VOXEL_RATIO,RANK_Z=$RANK_Z,NUMBER_TOP=$NUMBER_TOP,WWW_IN=$WWW_IN,RAW_H5=$RAW_H5,RAW_JPG=$RAW_JPG,ROOT_OUT=$ROOT_OUT --array=0-$((NUMBER_TOP - 1)) all_x3d.sbatch
   ;;
