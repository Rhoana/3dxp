...
IDS_LIST="9094 147846 32265 4239 44692 22678 219033 22809 373657 22814 223007 171043 359972 145958 28074 395310 213936 25009 61746 36659 51377 13493 4278 208056 90810 53179 17731 24644 44740 37196 105292 44877 240730 212318 94946 22754 161124 20202 107115 161131 8562 2290 9080 146038 93302 11384 163323 9982"
...
INDEX_NAME="37synapses_48neurons.html"
...
for STEP in $(seq $START $STOP); do
    ...
    3) 
        ...
        LOGS_3A="-o $LOG_OUT/all_stl/list_%a.out -e $LOG_OUT/all_stl/list_%a.err"
    ...
    4) 
        ...
        LOGS_4A="-o $LOG_OUT/all_x3d/list_%a.out -e $LOG_OUT/all_x3d/list_%a.err"
    ...
    5) 
        ...
        LOGS_5A="-o $LOG_OUT/simple/merge_1.out -e $LOG_OUT/simple/merge_1.err"
